...
const handleChangeDirection = (dir: 'ltr' | 'rtl') => {
  direction.value = dir
...
useCookie('lang').value = $getLocale()
const switchLocale = (key: string) => {
  $switchLocale(key)
  useCookie('lang').value = key
}
</script>
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-3 gap-2">
              <Button variant="outline" :class="{ 'border-primary border-2': sidebar.variant === 'sidebar' }"
                @click="sidebar.variant = 'sidebar'">
                Sidebar
              </Button>
              <Button variant="outline" :class="{ 'border-primary border-2': sidebar.variant === 'floating' }"
                @click="sidebar.variant = 'floating'">
                Floating
              </Button>
              <Button variant="outline" :class="{ 'border-primary border-2': sidebar.variant === 'inset' }"
          ...
          <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-2 gap-2">
              <Button variant="outline" :class="{ 'border-primary border-2': direction === 'ltr' }"
                @click="handleChangeDirection('ltr')">
                LTR
              </Button>
              <Button variant="outline" :class="{ 'border-primary border-2': direction === 'rtl' }"
          ...
          <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-2 gap-2">
              <Button variant="outline" :class="{ 'border-primary border-2': $getLocale() === 'en' }"
                @click="switchLocale('en')">
                {{ $t('en') }}
              </Button>
              <Button variant="outline" :class="{ 'border-primary border-2': $getLocale() === 'zh-CN' }"
