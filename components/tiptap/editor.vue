      ...
      <div class="container flex h-14 items-center sticky">
        <div class="mr-4 md:mr-1 hidden md:flex">
          <a href="/" class="mr-4 md:mr-2 lg:mr-6 flex items-center lg:space-x1 xl:space-x-2">
            <svg viewBox="0 0 24 24" width="24" height="24" class="mr-2" fill="none" stroke="currentColor"
        ...
        <!-- <div class="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          ...
          <nav class="flex items-center gap-0.5">
            <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground w-8 h-8"
              href="https://github.com/Seedsa/echo-editor" target="_blank"><svg viewBox="0 0 15 15" width="1.2em"
                height="1.2em" class="w-4 h-4">
              ...
              <svg v-if="colorMode.value === 'dark'" viewBox="0 0 24 24" width="1.2em" height="1.2em"
    ...
    <div class="my-0 mx-auto max-w-[1024px] p-6">
      <div class="mb-2">
        <button
          ...
          @click="switchLocale('zh-CN')">中文</button>
        <button
          class="inline-flex items-center justify-center rounded-md px-3 py-2 text-sm transition-colors hover:bg-accent hover:text-accent-foreground"
      ...
      <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
        <echo-editor v-model="content" :extensions="extensions" :hideToolbar="hideToolbar" :hideMenubar="hideMenubar"
          :disabled="disabled" :maxHeight="512" output="html" :dark="colorMode.value === 'dark'"> </echo-editor>
      </div>
...
const content = ref('<h1>Echo Editor</h1><p>Welcome to the Echo Editor demo!</p>')
