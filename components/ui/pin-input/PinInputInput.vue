...
<template>
  <PinInputInput v-bind="forwardedProps" :class="cn('relative text-center bg-background shadow-sm focus:outline-none focus:ring-2 focus:ring-ring focus:relative focus:z-10 flex h-9 w-9 items-center justify-center border-y border-r border-input text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md', props.class)" />
</template>
